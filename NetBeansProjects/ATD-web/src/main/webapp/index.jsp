            ...
            <%
                ...
                if(hetBedrijf != null){
                    ...
                    out.println("<h3>Klanten</h3>");
                    for(Klant k : b.getAlleKlanten()){
                        out.println("<p>" + k.getUsername() + " - ");
                        out.println(k.getWachtwoord() + " - ");
                        out.println(k.getNaam() + "</p>");
                    }
                    out.println("<h3>Medewerkers</h3>");
                    for(Medewerker m : b.getAlleMedewerkers()){
                        out.println("<p>" + m.getUsername() + " - ");
                        out.println(m.getWachtwoord() + " - ");
                        out.println(m.getNaam() + "</p>");
                    }
